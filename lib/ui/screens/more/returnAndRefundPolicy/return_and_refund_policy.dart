...
class ReturnAndRefundPolicyScreen extends StatefulWidget {
  const ReturnAndRefundPolicyScreen({Key? key}) : super(key: key);

  @override
  State<ReturnAndRefundPolicyScreen> createState() =>
      _ReturnAndRefundPolicyScreen();
}

class _ReturnAndRefundPolicyScreen extends State<ReturnAndRefundPolicyScreen> {
  final ReturnAndRefundPolicyScreen = Get.put(TermsAndConditionController());
  final changeLanguageController = Get.put(ChangeLanguageController());

  @override
  void initState() {
    ReturnAndRefundPolicyScreen.getTermsAndConditions("ReturnRefundPolicy");
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text('return_and_refund_policy'.tr(),
              style:  TextStyle(
                  fontSize: 14.sp,
      ...
      body: Obx(() =>!ReturnAndRefundPolicyScreen.isLoading.value? Column(
        children: [
          Expanded(
  ...
  Widget kk(){
    return Row(
      ...
      children: [
        ...
        Flexible(
          child: Html(
            data: ReturnAndRefundPolicyScreen.termsAndConditionsResponse.value.data!.content??"",
          ),
        ),
      ],
    );
