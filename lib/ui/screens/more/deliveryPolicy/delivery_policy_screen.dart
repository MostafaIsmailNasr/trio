...
class DeliveryPolicyScreen extends StatefulWidget {
  ...
  @override
  State<DeliveryPolicyScreen> createState() =>
      _DeliveryPolicyScreen();
}

class _DeliveryPolicyScreen extends State<DeliveryPolicyScreen> {
  final deliveryPolicyController = Get.put(TermsAndConditionController());
  final changeLanguageController = Get.put(ChangeLanguageController());

  @override
  void initState() {
    deliveryPolicyController.getTermsAndConditions("delivery_policy");
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() =>!deliveryPolicyController.isLoading.value? Column(
        children: [
          Expanded(
  ...
  Widget kk(){
    return Row(
      ...
      children: [
        ...
        Flexible(
          child: Html(
            data: deliveryPolicyController.termsAndConditionsResponse.value.data!.content??"",
          ),
        ),
      ],
    );
